                    ...
                    <form className="forms-sample" action='' method='POST' encType='multipart/form-data'>
                        <div className="row">
                            <div className="col">
                                ...
                                <input type="text" onChange={(event) => {setarticle_title(event.target.value);}} className="form-control" placeholder="Enter Article Title..." />
                            </div>
                        </div>
                        <div className="row mt-1">
                            <div className="col">
                                <span><b>Corresponding Email</b></span>
                                <input type="email" onChange={(event) => {setco_author_email(event.target.value);}} className="form-control" placeholder="Enter Article Authors..." />
                            </div>
                        </div>
                        <div className="form-group mt-1">
                            <span ><b>Department/Affiliation</b></span>
                            <textarea onChange={(event) => {setdept(event.target.value);}} className="form-control" rows="3"></textarea>
                        </div>
                        <div className="form-group mt-1">
                            <span><b>Abstract</b></span>
                            <textarea className="form-control" onChange={(event) => {setabstract(event.target.value);}} rows="5"></textarea>
                        </div>
                        <div className="row">
                            <div className="col-lg-12 mt-1">
                                <span><b>Keywords</b></span>
                                <input type="text" onChange={(event) => {setkeywords(event.target.value)}} className="form-control" placeholder="Enter Keywords" />
                            </div>
                        </div>
                        <div className='row'>

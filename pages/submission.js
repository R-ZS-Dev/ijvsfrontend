                                            ...
                                            <div className="auth-form-light text-left py-5 px-4 px-sm-5">
                                                ...
                                                <form className="pt-3" action='' method='POST'>
                                                    <div className="form-group">
                                                        <input type="email" required className="form-control form-control-lg" placeholder="Enter Email" />
                                                    </div>
                                                    <div className="form-group">
                                                        <input type="password" className="form-control form-control-lg" placeholder="Password" />
                                                    </div>
                                                    <div className="mt-3">
                                                        <Link className="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="article-sub-form">SIGN IN</Link>
                                                    </div>
                                                    <div className="my-2 d-flex justify-content-between align-items-center">
                                                        <Link href="userforpass" className="auth-link text-black">Forgot password?</Link>
                                                    </div>
